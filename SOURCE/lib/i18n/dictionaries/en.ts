...
export const en = {
  ...
  // {min} — KHÔNG viết số cứng: câu này từng ghi "6" trong khi server bắt 10,
  // nên người dùng làm đúng theo gợi ý vẫn bị từ chối. Giá trị đến từ
  // PASSWORD_MIN_LENGTH (lib/auth/passwordPolicy.ts), một nguồn duy nhất.
  ...
  // WeakTopicsCard — chủ đề cụ thể cần sửa, chạy cho CẢ 7 môn (không phụ thuộc
  // taxonomy kỹ năng chỉ-có-Toán của Engine 1).
  "analytics.weakTopicsTitle": "What to work on",
  "analytics.weakTopicsHint": "Your lowest-accuracy topics in this range.",
  "analytics.weakTopicsEmpty": "Nothing stands out yet.",
  "analytics.weakTopicsEmptyHint":
    "Finish a few more exams — a topic needs at least {min} answered questions before it shows up here.",
  "analytics.weakTopicScore": "{correct}/{total} correct · {accuracy}%",
  ...
  // Editable part heading (2026-09-03).
  "upload.partTitleLabel": "Heading for part {part}, as printed on the exam",
  // Bulk marks panel (2026-09-03).
  "upload.pointsPanelTitle": "Marks",
  "upload.pointsPanelTotal": "{total}/{expected}",
  "upload.pointsPanelPartLabel": "Part to assign marks to",
  "upload.pointsPanelUseRange": "Pick a range",
  "upload.pointsPanelUseWholePart": "Whole part",
  "upload.pointsPanelFromLabel": "From question",
  "upload.pointsPanelToLabel": "To question",
  "upload.pointsPanelRangeTo": "to",
  "upload.pointsPanelScopeSummary": "{count} questions (Q{first}–Q{last})",
  "upload.pointsPanelNoQuestions": "No questions in this range.",
  "upload.pointsPanelTotalLabel": "Total marks for the selected range",
  "upload.pointsPanelTotalPlaceholder": "e.g. 3",
  "upload.pointsPanelApply": "Split marks",
  "upload.pointsPanelShowRatio": "Adjust each question's share",
  "upload.pointsPanelHideRatio": "Hide shares",
  "upload.pointsPanelRatioHint": "Leave blank to split evenly. A bigger number means that question is worth more.",
  "upload.pointsPanelRatioLabel": "Share for question {number}",
  "upload.pointsPanelInvalidTotal": "Enter a total greater than 0.",
  "upload.pointsPanelEmptyScope": "Pick a part or range that has at least one question.",
  "upload.pointsPanelCannotSplit": "That total is too small to split across {count} questions — every question must be worth more than 0.",
  ...
  "rating.mcqDescription": "Four options, one correct answer — tests recall and understanding.",
  "rating.tfEyebrow": "PART II · TRUE / FALSE",
  "rating.tfName": "True / False",
  "rating.tfDescription":
    "Mark each sub-statement true or false. One wrong sub-statement forfeits the question.",
  ...
  "history.pdfResultTitle": "EXAM RESULT",
  "history.pdfScoreLabel": "SCORE",
  "history.pdfExamineeLabel": "EXAMINEE",
  "history.pdfSubmittedLabel": "SUBMITTED AT",
  "history.pdfCorrectLabel": "CORRECT",
  "history.pdfWrongLabel": "WRONG",
  "history.pdfTotalQuestions": "{total} questions total",
  "history.exam": "Exam",
  "history.score": "Score",
