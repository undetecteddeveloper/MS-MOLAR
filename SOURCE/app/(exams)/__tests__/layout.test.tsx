...
// (exams)/layout.tsx — EntitlementProvider mount (backend DD D005 / I1, ADR-0013
 ...
 *  Nó đứng ở vị trí một `page.tsx` của (exams) — nghĩa là `children` của
...
describe("(exams)/layout.tsx — đứa con bị gate KHÔNG nhận FREE_FALLBACK (I1)", () => {
...
describe("(exams)/layout.tsx — đúng MỘT lượt đọc mỗi request (UI-D1)", () => {
...
describe("(exams)/layout.tsx — mã nguồn: không memo hoá, không đường đọc thứ hai", () => {
