...
- [x] Quality checks (types, lint, format) — zero errors on every rating-system-owned file (pre-existing unrelated `(layer3)`/`lib/scoring` gaps documented and untouched, out of this feature's scope)
