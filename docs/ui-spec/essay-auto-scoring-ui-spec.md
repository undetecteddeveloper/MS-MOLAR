...
| **O-6** | **ĐÃ ĐÓNG MỘT NỬA 2026-08-29 (v1.4).** Bốn hằng polling vốn chốt từ **mục tiêu độ trễ trong PRD** chứ không từ đo đạc. Mục tiêu đó đã đổi (OQ-7 → ≤ 3 phút), nên **hai trần đã dịch: 18 → 30 lượt, 120 → 240 giây**, và quan trọng hơn là **đã đổi mốc neo** — 240 000 ms bây giờ bằng `ESSAY_PASS_BUDGET_MS`, tức trần đồng hồ của chính lượt chấm, chứ không còn là một bội số của một con số kỳ vọng. **Còn mở:** hai hằng **nhịp** (5s×12 → 10s) vẫn chưa có đo đạc đằng sau; vòng round-trip Singapore→Groq **vẫn chưa được đo** (C4). **Hạn chờ đọc-lúc-render vẫn là một con số khác và không dịch theo** (AC-061) | Kỹ sư, khi có số đo | Phần còn lại: Phase E / Task E5 |
